...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE users SET id = '$id', email = '$email', password = '$password' WHERE id = $id";
  ...
  <div class="card-body">
    <div class="form-group row mb-4">
      ...
      <div class="col-sm-12 col-md-7">
        <input type="text" class="form-control" name="id" id="id" value="<?= isset($data['id']) ? $data['id'] : '' ?>" required>
      </div>
    </div>
    <div class="form-group row mb-4">
